...
class node:
    ...
    def sendTx(self, dest_Node, tx):
        dest_Node.recvTx(tx) # We are simulating the nodes receiving new transactions over the internet. This is purely local, however.
        return -1
    ...
    # Save the blockchain the node currently has stored in memory.
